---
layout: post
title: 'Fix: Dark background when taking pictures or making pictures with HoloLens 2 and OpenXR'
...
- OpenRX
featuredImageUrl: https://LocalJoost.github.io/assets/2021-12-08-Fix-Dark-background-when-taking-pictures-or-making-pictures-with-HoloLens-2-and-OpenXR/dark.png
comment_issue_id: 394
---
## The problem 
...
![](/assets/2021-12-08-Fix-Dark-background-when-taking-pictures-or-making-pictures-with-HoloLens-2-and-OpenXR/dark.png)

Now compare that to the login screen of our other app:

![](/assets/2021-12-08-Fix-Dark-background-when-taking-pictures-or-making-pictures-with-HoloLens-2-and-OpenXR/light.png)

I went back to earlier pictures and movies of OpenXR based app, and on that one the background was as clear as the other app. So what had changed? We did not upgrade Unity or anything else in the app. We just wrote code and added assets.

## The solution
The culprit turned out to be the Mixed Reality OpenXR plugin:

![](/assets/2021-12-08-Fix-Dark-background-when-taking-pictures-or-making-pictures-with-HoloLens-2-and-OpenXR/MRTKFT.png)
...
![](/assets/2021-12-08-Fix-Dark-background-when-taking-pictures-or-making-pictures-with-HoloLens-2-and-OpenXR/runtime.png)
