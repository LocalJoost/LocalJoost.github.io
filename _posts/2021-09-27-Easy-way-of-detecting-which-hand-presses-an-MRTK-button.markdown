...
---
Some UI elements cannot be neutral to the fact whether or not someone is right-handed or left-handed. For instance, if someone is left handed, you might want to place the props a user want to choose use on the left side of the user, in stead of default taking the right side. Inclusivity is the word these days, after all. Of course, you can make the user express an explicit choice for right or left handedness - but I decided to see if I could infer this from what hand the user used to operate the main menu. This menu was only buttons, and those buttons are pretty neutral to left- or right handedness.
