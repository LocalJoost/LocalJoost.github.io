---
layout: post
title: Populating MRKT toggle button state without an intermediary script
...
featuredImageUrl: https://LocalJoost.github.io/assets/2021-12-23-Populating-MRKT-toggle-button-state-without-an-intermediary-script/demo.gif
comment_issue_id: 397
---
...
![](/assets/2021-12-23-Populating-MRKT-toggle-button-state-without-an-intermediary-script/demo.gif)

The trick is in the Interactable's Receivers. This is a panel that is right below the Events

![](/assets/2021-12-23-Populating-MRKT-toggle-button-state-without-an-intermediary-script/events.png)
...
![](/assets/2021-12-23-Populating-MRKT-toggle-button-state-without-an-intermediary-script/receivers.png)
...
![](/assets/2021-12-23-Populating-MRKT-toggle-button-state-without-an-intermediary-script/addevent.png)
...
![](/assets/2021-12-23-Populating-MRKT-toggle-button-state-without-an-intermediary-script/togglereceiver.png)
...
![](/assets/2021-12-23-Populating-MRKT-toggle-button-state-without-an-intermediary-script/eventconfigured.png)
