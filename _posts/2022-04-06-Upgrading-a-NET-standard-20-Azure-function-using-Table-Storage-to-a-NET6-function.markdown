...
date: 2022-04-06T00:00:00.0000000+02:00
categories: []
tags:
- Azure
- Functions
- .NET 6
- Table Storage
featuredImageUrl: https://LocalJoost.github.io/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/solution.png
comment_issue_id: 413
---
To reassure my regular readers - no, I am not pivoting from Mixed Reality and HoloLens. Far from that! But you see, any HoloLens application that is more than a simple demo needs some kind of back end. My HoloLens application [AMS HoloATC](https://www.microsoft.com/store/apps/9NBLGGH52SZP), first published to the Microsoft Store in Q3 2016, uses an Azure function for the complex CPU-intensive calculations, needed to transform the raw aircraft location data coming from [ADS-B Exchange](https://www.adsbexchange.com/) into something HoloLens can project.  In fact, the [very first post I wrote about AMS HoloATC](https://localjoost.github.io/a-hololens-airplane-tracker-1/) specifically handles data services. More importantly, it caches results of a call to ADS-B Exchange for 20 seconds - as not to annoy the good folks running that site. I donate regularly to them and have a 'feeder' myself, but it's no use overextending your goodwill.
...
![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/solution.png)
...
![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/outdatedrun.png)

or when you run the tests:

![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/outdatedsdk.png)
...
![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/propertypages.png)
...
![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/sealed.png)
...
![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/rename.png)
* And then I created a fresh new project function project

![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/function1.png)

![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/function2.png)
...
![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/three_errors.png) 
...
![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/prerelease.png)
...
![](/assets/2022-04-06-Upgrading-a-NET-standard-20-Azure-function-using-Table-Storage-to-a-NET6-function/testrun.png)
...
Project - of course - [can be found on Github](https://github.com/LocalJoost/TableUpgrade). The main branch contains the upgraded code, if you want to see the old code, it's in [branch oldcode](https://github.com/LocalJoost/TableUpgrade/tree/oldcode).
