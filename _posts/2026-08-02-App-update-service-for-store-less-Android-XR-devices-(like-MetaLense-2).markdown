---
layout: post
title: App update service for store-less Android XR devices (like MetaLense 2)
...
![newversion](/assets/2026-08-02-App-update-service-for-store-less-Android-XR-devices-(like-MetaLense-2)/newversion.png)
...
![version2](/assets/2026-08-02-App-update-service-for-store-less-Android-XR-devices-(like-MetaLense-2)/version2.png)

However, if you *have* made the app Device Owner, it shows:

![askinstall](/assets/2026-08-02-App-update-service-for-store-less-Android-XR-devices-(like-MetaLense-2)/askinstall.png)

If you press "Yes" it will show that it's downloading:

![download](/assets/2026-08-02-App-update-service-for-store-less-Android-XR-devices-(like-MetaLense-2)/download.png)
...
![version1001](/assets/2026-08-02-App-update-service-for-store-less-Android-XR-devices-(like-MetaLense-2)/version1001.png)
