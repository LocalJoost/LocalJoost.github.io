...
You can download HoloATC for P&C MetaLense 2 [directly via this link](https://www.schaikweb.net/HoloATC/MTL2/HoloATC_MetaLense2_1.1.5.1.apk?v=1.1.5.1)

You can install it by connecting the MetaLense 2 to your PC, then install it by using the following command

```dos
adb install HoloATC_MetaLense2_1.1.5.1.apk
```
